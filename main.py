...
@app.post("/orders", response_model=Order, status_code=201) #khai bao duong dan
...
@app.get("/orders/{order_id}", response_model=Order) #khai bao duong dan lay don hang theo ID cua server
...
@app.put("/orders/{order_id}", response_model=Order) #khai bao duong dan de cap nhat don hang cua server
